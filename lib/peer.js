...
const debug = _debug('webtorrent:peer')
 ...
 */
export function createWebRTCPeer (conn, swarm) {
 ...
 */
export function createTCPIncomingPeer (conn) {
 ...
 * know what swarm the connection is intended for.
 */
export function createUTPIncomingPeer (conn) {
 ...
 */
export function createTCPOutgoingPeer (addr, swarm) {
 ...
 * available connection), the client can attempt to connect to the address.
 */
export function createUTPOutgoingPeer (addr, swarm) {
 ...
 */
export function createWebSeedPeer (conn, id, swarm) {
