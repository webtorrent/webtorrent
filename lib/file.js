  ...
  _serve (req) {
    const res = {
      ...
      headers: {
        ...
        'Accept-Ranges': 'bytes',
        'Content-Type': this._getMimeType()
      }
    }
    ...
    // TODO: add support for passthrough of readStreams, so that the user can for example parse video data
    return [res, req.method === 'GET' && this.createReadStream(range)]
  }
