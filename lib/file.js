...
/**
 * A File represents a single file within a torrent. Files can be selectively
 * downloaded and streamed while the torrent is being downloaded.
 *
...
export default class File extends EventEmitter {
   ...
   * @param {Torrent} torrent - The torrent this file belongs to
   * @param {Object} file - File metadata from parsed torrent
   * @param {string} file.name - The file name
   * @param {string} file.path - The file path within the torrent
   * @param {number} file.length - The file size in bytes
   * @param {number} file.offset - The byte offset of this file within the torrent
   */
   ...
   * @returns {number} Number of bytes downloaded
   */
  get downloaded () {
