...
const debug = require('debug')('webtorrent:nat-traversal')
const natUpnp = require('nat-upnp') // browser exclude
const natpmp = require('nat-pmp') // browser exclude
const network = require('network') // browser exclude
...
NatTraversal.prototype.portMapping = function (port, protocol, cb) {
  ...
  self._openedPorts.push({ port, protocol })
