...
const FALLBACK_STORE = !process.browser ||
(typeof navigator !== 'undefined' && navigator.storage?.getDirectory && typeof FileSystemFileHandle !== 'undefined' && FileSystemFileHandle?.prototype?.createWritable)
  ? FSChunkStore
  : MemoryChunkStore
