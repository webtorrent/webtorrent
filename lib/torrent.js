...
class Torrent extends EventEmitter {
  ...
  _select (start, end, priority, notify, isStreamSelection) {
    ...
    this._selections.add(start, end, priority, notify, isStreamSelection)
  ...
  _deselect (start, end, isStreamSelection) {
    ...
    this._selections.remove(start, end, isStreamSelection)

    this._updateSelections()
  }

  deselect (start, end, priority, notify) {
    this._deselect(start, end, priority, notify, false)
  }
