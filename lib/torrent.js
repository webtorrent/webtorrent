 ...
 * @param {Object} opts
 */
function Torrent (manager, parsedTorrent, opts) {
  var self = this
...
Torrent.prototype.attachStorage = function(storage) {
  var self = this
  self.storage = storage
  debug('attaching storage')
...
Torrent.prototype.updateMetadata = function(parsedTorrent) {
  var self = this
  self.parsedTorrent = parsedTorrent
...
Torrent.prototype._onWire = function (wire) {
  var self = this
  debug(!!self.metadata ? "Metadata" : " No MEta");
  ...
  if (!self.metadata) {
    wire.ut_metadata.on('metadata', function (metadata) {
      ...
      self.manager.onMetadata(metadata)
    })
