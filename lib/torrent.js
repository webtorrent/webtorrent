...
/**
 * Called after resume() is executed
 */
...
/**
 * Pause the progress of this torrent.
 */
Torrent.prototype.pause = function (cb) {
  var self = this

  if (self.destroyed || self.paused || self.done) return
  debug('on paused')
...
/**
 * Resume the progress of this torrent.
 */
...
Torrent.prototype._updateWire = function (wire) {
  ...
  function speedRanker () {
    ...
    return function (index) {
      ...
      for (ptr = 0; ptr < self.swarm.wires.length; ptr++) {
