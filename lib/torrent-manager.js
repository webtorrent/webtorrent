...
var $ = require('jquery'),
  ...
  portfinder = require('chrome-portfinder'),
...
function TorrentManager () {
  var self = this;
  if (!(self instanceof TorrentManager)){
...
Object.defineProperty(TorrentManager.prototype, 'ratio', {
  get: function () {
    var self = this,
      uploaded = self.torrents.reduce(function (total, torrent) {
        return total + torrent.uploaded;
      }, 0),
      downloaded = self.torrents.reduce(function (total, torrent) {
...
TorrentManager.prototype.getTorrent = function (infoHash) {
  var self = this,
    index,
    i;
  for (i = 0, len = self.torrents.length; i < len; i += 1) {
